...
class IntegrationConfig(Base):
    ...
    simulation_mode:  Mapped[bool]       = mapped_column(Boolean, nullable=False, server_default="true")
...
class WebhookSubscription(Base):
    """Outbound webhook — Trace sends events to this URL when configured events occur."""
    ...
    headers:           Mapped[dict]           = mapped_column(JSONB, nullable=False, server_default="{}")
    is_active:         Mapped[bool]           = mapped_column(Boolean, nullable=False, server_default="true")
    retry_policy:      Mapped[str]            = mapped_column(String(20), nullable=False, server_default="exponential")
    ...
    __table_args__ = (
        Index("ix_webhook_subs_tenant", "tenant_id"),
        Index("ix_webhook_subs_active", "tenant_id", "is_active"),
    )
