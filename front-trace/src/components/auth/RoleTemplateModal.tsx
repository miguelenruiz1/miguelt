...
function TemplateCard({
  ...
  return (
    <div className="group relative flex flex-col items-start gap-2 rounded-xl border border-border bg-card p-4 transition-all hover:border-primary/30 hover:shadow-md">
      <div className="flex items-center gap-3 w-full">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-[11px] text-muted-foreground font-mono">{template.slug}</div>
        </div>
        {onDelete && (
          <button
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="w-full max-w-2xl rounded-2xl bg-card shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-border px-6 py-4">
          <div>
            <h2 className="text-lg font-bold text-foreground">Crear rol desde plantilla</h2>
