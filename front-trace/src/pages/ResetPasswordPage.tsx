        ...
        <div className="relative flex flex-col justify-center w-full h-screen lg:flex-row sm:p-0">
          <div className="flex flex-col flex-1">
            <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto text-center">
              ...
              <h1 className="mb-2 text-2xl font-semibold text-foreground">Contraseña actualizada</h1>
              <p className="text-sm text-muted-foreground mb-8">Tu contraseña ha sido restablecida exitosamente.</p>
              <button
