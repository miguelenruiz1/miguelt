  ...
  return (
    <div className="p-8 space-y-6 max-w-5xl mx-auto">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-muted-foreground">
        ...
        <span className="text-foreground font-medium">Tipos de movimiento</span>
      </nav>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">Tipos de movimiento</h1>
      ...
      {isLoading ? (
        ...
        <div className="bg-card rounded-2xl border-2 border-dashed border-border p-16 text-center">
          ...
          <h3 className="text-sm font-semibold text-foreground mb-1">Sin tipos de movimiento</h3>
          <p className="text-xs text-muted-foreground mb-4">Crea tu primer tipo para clasificar tus movimientos.</p>
          <button onClick={openCreate}
