  ...
  return (
    <div className="p-8 space-y-6 max-w-5xl mx-auto">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-slate-400">
        ...
        <span className="text-slate-700 font-medium">Tipos de proveedor</span>
      </nav>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900">Tipos de proveedor</h1>
            <p className="text-sm text-slate-500">Clasifica tus proveedores</p>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-2xl border-2 border-dashed border-slate-200 p-16 text-center">
          ...
          <h3 className="text-sm font-semibold text-slate-700 mb-1">Sin tipos de proveedor</h3>
          <p className="text-xs text-slate-400 mb-4">Crea tu primer tipo para clasificar tus proveedores.</p>
          <button onClick={openCreate}
