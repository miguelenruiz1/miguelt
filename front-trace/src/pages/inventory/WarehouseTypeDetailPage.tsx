      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input type="number" value={form.sort_order} disabled={disabled}
            ...
            className="w-32 rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring disabled:bg-slate-50 disabled:text-slate-400" />
        </div>
