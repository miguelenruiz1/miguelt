      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input type="number" value={form.sort_order} disabled={disabled}
            ...
            className="w-32 rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 disabled:bg-slate-50 disabled:text-slate-400" />
        </div>
        ...
        <div className="rounded-lg bg-slate-50 px-4 py-3">
          ...
          <code className="text-sm font-mono text-slate-700">{warehouseType.slug}</code>
        </div>
      </div>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <p className="text-sm text-slate-500">Campos exclusivos de este tipo de bodega</p>
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border-2 border-dashed border-slate-200 p-10 text-center">
          ...
          <p className="text-xs text-slate-400 mb-4">Crea campos exclusivos para este tipo de bodega.</p>
          <button onClick={openCreate}
  ...
  return (
    <div className="p-8 space-y-6 max-w-5xl mx-auto">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-slate-400">
        ...
        <Link to="/inventario/configuracion/tipos-bodega" className="hover:text-slate-600 transition-colors">Tipos de bodega</Link>
        <ChevronRight className="h-3 w-3" />
        <span className="text-slate-700 font-medium">{warehouseType.name}</span>
      </nav>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold text-slate-900">{warehouseType.name}</h1>
          ...
          {warehouseType.description && (
            <p className="text-sm text-slate-500">{warehouseType.description}</p>
          )}
        </div>
