  ...
  return (
    <div className="p-8 space-y-6 max-w-5xl mx-auto">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-slate-400">
        ...
        <span className="text-slate-700 font-medium">Tipos de bodega</span>
      </nav>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900">Tipos de bodega</h1>
            <p className="text-sm text-slate-500">Clasificación de almacenes</p>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-2xl border-2 border-dashed border-slate-200 p-16 text-center">
          ...
          <h3 className="text-sm font-semibold text-slate-700 mb-1">Sin tipos de bodega</h3>
          <p className="text-xs text-slate-400 mb-4">Crea tu primer tipo para clasificar tus bodegas.</p>
          <button onClick={openCreate}
