    ...
    <form onSubmit={submit} className="space-y-6 max-w-xl">
      <div className="space-y-4">
        ...
        <div className="rounded-lg bg-muted px-4 py-3">
          ...
          <code className="text-sm font-mono text-foreground">{supplierType.slug}</code>
        </div>
      </div>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">Campos exclusivos de este tipo de proveedor</p>
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border-2 border-dashed border-border p-10 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-4">Crea campos exclusivos para este tipo de proveedor.</p>
          <button onClick={openCreate}
  ...
  return (
    <div className="p-8 space-y-6 max-w-5xl mx-auto">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-muted-foreground">
        ...
        <Link to="/inventario/configuracion/tipos-proveedor" className="hover:text-muted-foreground transition-colors">Tipos de proveedor</Link>
        <ChevronRight className="h-3 w-3" />
        <span className="text-foreground font-medium">{supplierType.name}</span>
      </nav>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="text-xl font-bold text-foreground">{supplierType.name}</h1>
          {supplierType.description && (
            <p className="text-sm text-muted-foreground">{supplierType.description}</p>
          )}
        </div>
