...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("global_daily_limit_starter", sa.Integer, server_default="3", nullable=False),
        sa.Column("global_daily_limit_professional", sa.Integer, server_default="10", nullable=False),
        sa.Column("global_daily_limit_enterprise", sa.Integer, server_default="30", nullable=False),
        ...
        sa.Column("estimated_cost_per_analysis_usd", sa.Numeric(10, 6), server_default="0.006", nullable=False),
